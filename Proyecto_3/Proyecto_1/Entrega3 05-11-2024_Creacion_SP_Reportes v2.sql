...
GO
CREATE or ALTER PROCEDURE update3.ReporteTrimestral (@trimestre int, @anio int)
as
begin
SELECT
...
GO
CREATE or ALTER PROCEDURE update3.ReporteRango (@fechaI date, @fechaF date)
as
begin
SELECT
...
GO
CREATE or ALTER PROCEDURE update3.ReporteRangoSucursal (@fechaI date, @fechaF date)
as
begin
SELECT
...
GO
CREATE or ALTER PROCEDURE update3.ReporteMenosVendidos (@mes int, @anio int)
as
begin
...
GO
CREATE or ALTER PROCEDURE update3.VentasFechaSucursal (@fecha date, @sucursal int)
as
begin
	SELECT
