...
EXEC sp_executesql @sql;
	...
	SELECT e.Nombre, e.Apellido, e.DNI, e.Direccion ,REPLACE(REPLACE(e.email_Personal,' ',''),CHAR(9),''),
	       REPLACE(REPLACE(e.email_Empresa,' ',''),CHAR(9),''), e.CUIL,e.Cargo, s.id_sucursal, e.Turno
...
BEGIN
	...
	INSERT INTO ventas3.Venta(Tipo_Cliente,Genero,id_Sucursal,id_Empleado,id_Factura,Fecha)
	...
	UPDATE ventas3.Factura
SET Total = (
    SELECT SUM(dv.cantidad * dv.precio_unitario*1.21)
