...
DECLARE @MSJ varchar(50) = ''
	...
	IF(@MSJ ='')
BEGIN
	INSERT INTO ventas3.Venta(Tipo_Cliente,Genero,cuil_cte,id_Sucursal,id_Empleado,id_Factura,Fecha)
	VALUES(@Tipo_Cliente,
			@Genero,
			@Cuil_cte,
...
SET @Numero_Factura = '233-95-6012'
SET @tipo_factura = 'A'
...
DECLARE @Cuil_cte CHAR(13)
DECLARE @id_Empleado int
SET @Tipo_Cliente = 'Member'
SET @Genero = 'Male'
SET @Cuil_cte = '222-51-6910'
SET @id_Empleado = 257020
EXEC ventas3.InsertarVenta @Tipo_Cliente, @Genero,@Cuil_cte, @id_Empleado, @Numero_Factura
