...
---MOSTRAMOS FUNCION DE RESTRICCION PARA SUPERVISOR Y PARA CAJERO
EXECUTE AS USER = 'Prueba1_Usuario_S';

exec administracion3.BorrarProducto 1

SELECT * FROM ventas3.Factura

REVERT;

EXECUTE AS USER = 'Prueba1_Usuario_V'

exec administracion3.BorrarProducto 2

exec ventas3.BorrarVenta 1
